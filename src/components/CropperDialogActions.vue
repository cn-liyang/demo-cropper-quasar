...
<template>
  <q-card-actions class="flex justify-between q-gutter-sm">
    ...
    <q-btn push color="positive" icon="rotate_right" round @click.prevent="doRotateR()" />
    <q-btn push color="positive" icon="settings_backup_restore" round @click.prevent="doReset()" />
